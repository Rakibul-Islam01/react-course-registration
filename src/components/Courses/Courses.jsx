...
const Courses = ({handleAddToCourses}) => {
    ...
    return (
        <div className="md:w-3/4 bg-slate-300 rounded-sm">
            <h3 className="text-2xl text-black font-bold pt-4 text-center border-b-2 pb-3"> Total Courses Found: {courses.length}</h3>
